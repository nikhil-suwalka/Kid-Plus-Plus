...
//            filename= args[0];
            ...
            try {
                ...
                while (scanner.hasNextLine()) {
                    ...
                    if (is_index > 0) {
                        setDataType(words.get(is_index - 1), getValue(line.substring(line.indexOf("is") + 3)));
                    }
                }
                scanner.close();
    ...
    static class CantFindSymbol extends Exception {
        public CantFindSymbol(String data) {
            super("Cant find symbol: " + data);
        }
    }
    
    static class InvalidOperation extends Exception {
